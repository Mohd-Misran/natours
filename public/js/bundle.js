...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWlzcmFuMzgiLCJhIjoiY2trMm4xYWszMTJuZjJxdGdlOW80b2d1ZiJ9.FOZHAqeTo1lFABzI4Vhqlw';
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Add marker, set coordinates, and add to map
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description)).addTo(map); // Extend map bounds to include current location
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/update-my-password' : 'http://127.0.0.1:3000/api/v1/users/update-my-data';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Changes are saved.');
              location.reload();
            }
...
var stripe = Stripe('pk_test_51IBh2aAL0tKSBG8QKvHyQYyvWtaQdWN8Na70Gn0TvzhznxhFjkhqtgFkY98Iqc5Mp6r2P04Jgybvris4PqQXwe9J00qps5v1hj');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            console.log(res); // 2) Create checkout form + charge credit card
...
if (logoutBtn) logoutBtn.addEventListener('click', /*#__PURE__*/function () {
...
var updateDataForm = document.getElementById('update-user-data-form');
if (updateDataForm) updateDataForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 8;
            return (0, _updateAccount.updateSettings)('data', form);
...
var updatePasswordForm = document.getElementById('update-user-password-form');
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            newPasswordConfirm = document.getElementById('password-new-confirm').value;
            _context4.next = 6;
            return (0, _updateAccount.updateSettings)('password', {
